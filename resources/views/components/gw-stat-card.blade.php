        ...
        @if ($tooltip)
            ...
            >
                <button
                    ...
                    @blur="open = false"
                    @click.prevent="open = true; setPlacement()"
                ...
                <span
                    ...
                    class="absolute top-5 z-40 w-56 max-w-[calc(100vw-1rem)] rounded-lg border border-gray-600 bg-primary px-2 py-1 text-xs text-gray-200 shadow-lg"
                >
                    {{ $tooltip }}
                </span>
            </span>
