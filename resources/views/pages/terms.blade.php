    ...
    <main class=" p-4 space-y-6">
        ...
        <div class="glass mt-8 p-6 sm:p-8 space-y-6">
            ...
            <section class="space-y-3">
                ...
                <p>
                    FPL Galaxy uses official Fantasy Premier League (FPL) APIs to fetch league statistics. By using our service, you acknowledge and agree that data is retrieved from FPL's public API and updated automatically after each gameweek. For more information, see 
                    <a href="https://fantasy.premierleague.com/help/terms" class="text-indigo-400 hover:text-indigo-300">FPL API policies</a>.
                </p>
            </section>
            ...
            <section class="space-y-3">
                ...
                <p>
                    Our site is free to use. To maintain our platform, we display advertisements through Google AdSense. For more details, visit 
                    <a href="https://policies.google.com/technologies/ads" class="text-indigo-400 hover:text-indigo-300">AdSense Policies</a>.
                </p>
            </section>
            ...
            <section class="space-y-3">
                ...
                <p>
                    ...
                    <a href="mailto:admin@thetechtower.com" class="text-indigo-400 hover:text-indigo-300">admin@thetechtower.com</a> 
                    or 
