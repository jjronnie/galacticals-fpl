                   ...
                   <table class="min-w-full text-left text-sm font-light">
                    ...
                    <tbody>
                        @forelse($leagues as $index => $league)
                                ...
                                <td class="whitespace-nowrap px-6 py-4 font-bold">  <a href="{{ route('public.stats.show', ['league_id' => $league->league_id]) }}" class="text-indigo-400 hover:text-indigo-300 font-bold px-3 py-1 rounded-md border border-indigo-400 hover:border-indigo-300 transition duration-150">
                                    View League
                                </a></td>
                            </tr>
                        @empty
