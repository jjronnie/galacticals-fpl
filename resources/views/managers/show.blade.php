    ...
    <div class="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
        ...
        @else
            ...
            <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <x-stat-card title="Bench Points" :value="$stats['summary']['bench_points'] ?? 0" icon="armchair" tooltip="Total points left on bench throughout the season." />
            ...
            <section class="grid gap-6 lg:grid-cols-2">
                <div class="rounded-2xl border border-gray-700 bg-card p-5">
                    ...
                    <p class="mb-4 text-xs text-gray-400">Weekly points against average and best score.</p>
                ...
                <div class="rounded-2xl border border-gray-700 bg-card p-5">
                    ...
                    <p class="mb-4 text-xs text-gray-400">Team value by gameweek.</p>
